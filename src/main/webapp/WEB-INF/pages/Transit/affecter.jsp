                ...
                <form role="form" action="affecterAction" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <div class="radio">
                        <label>
                          <input type="radio" name="choix" id="optionsRadios1" value="transporteur" checked>
		          	...
		          	<div class="form-group" id="transporteur" style="display:none;">
		          	<label for="exampleInputEmail1">Transporteur</label>
		               <select class="form-control" name="transporteurId" style="diplay:none;">
