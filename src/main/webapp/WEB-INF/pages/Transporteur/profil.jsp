...
<html>
  <head>
    <meta charset="UTF-8">
    <title>${user.nomuser} ${user.prenomuser}</title>
 ...
 -->
      <div class="register-box-body">
        <p class="login-box-msg">${user.nomuser} ${user.prenomuser}</p>
        <form action="profilSetting.htm" method="post">
          <div class="form-group has-feedback">
            <input required type="text" class="form-control" placeholder="Nom" name="nomuser" value="${user.nomuser}"/>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input required type="text" class="form-control" placeholder="Prenom" name="prenomuser" value="${user.prenomuser}"/>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input required type="email" class="form-control" placeholder="Email" name="emailuser" value="${user.emailuser}"/>
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input required type="text" class="form-control" placeholder="Login" name="username" value="${user.username}"/>
          ...
          <div class="form-group has-feedback">
            <input required type="text" class="form-control" placeholder="phoneuser" name="phoneuser" value="${user.phoneuser}"/>
            <span class="glyphicon glyphicon-phone form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input required type="file" class="form-control" placeholder="logo" name="file" value="${user.logo}"/>
            <span class="glyphicon glyphicon-phone form-control-feedback"></span>
          </div>
          ...
          <div class="col-xs-8">    
              <div class="checkbox icheck">
                <label>
                  <a href="/Transporteur/TransporteurProfil">Retour</a>
                </label>
              </div>                        
            </div>
            <div class="col-xs-4">
